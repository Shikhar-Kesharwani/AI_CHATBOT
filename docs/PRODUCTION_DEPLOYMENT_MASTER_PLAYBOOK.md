...
*(Note: Additional chapters from the user's prompt (4 through 22) are preserved and part of this playbook as a holistic operational guide, though truncated here for brevity in the file itself. Refer back to the playbook source when executing steps for chapters 4–22.)*
